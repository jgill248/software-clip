...
This is intentionally separate from the normal Softclip dev image.
...
```sh
review-checkout-pr jgill248/software-clip 432
cd /work/checkouts/softclip-softclip/pr-432
```
...
## Preview the Softclip app from the PR
...
- Softclip's embedded PostgreSQL and local storage stay inside the container home volume via `SOFTCLIP_HOME=/home/reviewer/.softclip-review`.
