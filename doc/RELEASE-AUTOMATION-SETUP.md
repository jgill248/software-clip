...
This document covers the GitHub and npm setup required for the current Softclip release model:
...
Do this for every public package that Softclip publishes.
...
3. add a trusted publisher for the GitHub repository `jgill248/software-clip`
...
2. revoke any personal automation token that used to publish Softclip
