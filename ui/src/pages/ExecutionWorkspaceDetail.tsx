...
import type { ExecutionWorkspace, Issue, Project, ProjectWorkspace } from "@softclipai/shared";
...
function ExecutionWorkspaceIssuesList({
  ...
  return (
    <IssuesList
      ...
      viewStateKey="softclip:execution-workspace-issues-view"
...
export function ExecutionWorkspaceDetail() {
  ...
  if (workspaceId && activeTab === null) {
    ...
    try {
      const storedTab = localStorage.getItem(`softclip:execution-workspace-tab:${workspaceId}`);
  ...
  const handleTabChange = (tab: ExecutionWorkspaceTab) => {
    try {
      localStorage.setItem(`softclip:execution-workspace-tab:${workspace.id}`, tab);
    } catch {}
      ...
      <div className="space-y-4 overflow-hidden sm:space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="max-w-2xl text-sm text-muted-foreground">
            Configure the concrete runtime workspace that Softclip reuses for this issue flow.
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="rounded-2xl border border-border bg-card p-4 sm:p-5">
              ...
              <div className="space-y-4">
                ...
                <Field label="Provision command" hint="Runs when Softclip prepares this execution workspace">
                  <textarea
