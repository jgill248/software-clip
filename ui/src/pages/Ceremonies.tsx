...
import type { RoutineListItem, RoutineVariable } from "@softclipai/shared";
...
export function Ceremonies() {
  ...
  const routineViewStateKey = selectedCompanyId
    ? `softclip:routines-view:${selectedCompanyId}`
    : "softclip:routines-view";
  ...
  const updateRoutineStatus = useMutation({
    ...
    onError: (mutationError) => {
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : "Softclip could not update the routine.",
        tone: "error",
      });
    },
  });
  ...
  const runRoutine = useMutation({
    ...
    onError: (mutationError) => {
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : "Softclip could not start the routine run.",
        tone: "error",
      });
    },
  });
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange}>
        ...
        <TabsContent value="runs">
          <IssuesList
            ...
            viewStateKey="softclip:routine-recent-runs-view"
        ...
        >
          ...
          <div className="shrink-0 flex flex-col gap-3 border-t border-border/60 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="text-sm text-muted-foreground">
              After creation, Softclip takes you straight to trigger setup. Draft routines stay paused until you add a default agent.
            </div>
