...
import type { AuthSession, CurrentUserProfile, UpdateCurrentUserProfile } from "@softclipai/shared";
...
export function ProfileSettings() {
  ...
  const uploadHint = selectedCompany
    ? `Stored in Softclip file storage for ${selectedCompany.name}.`
    : "Select a company to upload an avatar into Softclip storage.";
