...
export const runTranscriptFixtureEntries: TranscriptEntry[] = [
  {
    ...
    text: "[softclip] Skipping saved session resume for task \"PAP-473\" because wake reason is issue_assigned.",
  },
  {
    kind: "init",
  ...
  },
  {
    ...
    text: "I’m starting with the Softclip heartbeat procedure and the repo-required docs so I can see what task is actually assigned and then work only on that scope.",
  },
  {
    kind: "tool_call",
  ...
  },
  {
    ...
    toolUseId: "item_1",
    content: "command: sed -n '1,220p' doc/GOAL.md\nstatus: completed\nexit_code: 0\n\n# Softclip\n\nSoftclip is the backbone of the autonomous economy.",
    isError: false,
  },
  {
    kind: "tool_result",
