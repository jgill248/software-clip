/**
 * @fileoverview Frontend API client for the Softclip plugin system.
 *
...
export const pluginsApi = {
   ...
   *
   * @param params.packageName - npm package name (e.g. `@softclip/plugin-linear`)
   ...
   * @param productId - Optional company scope used for board/company access checks.
