...
export const DISMISSED_KEY = "softclip:inbox:dismissed";
export const READ_ITEMS_KEY = "softclip:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "softclip:inbox:last-tab";
export const INBOX_ISSUE_COLUMNS_KEY = "softclip:inbox:issue-columns";
export const INBOX_NESTING_KEY = "softclip:inbox:nesting";
export const INBOX_GROUP_BY_KEY = "softclip:inbox:group-by";
export const INBOX_FILTER_PREFERENCES_KEY_PREFIX = "softclip:inbox:filters";
export const INBOX_COLLAPSED_GROUPS_KEY_PREFIX = "softclip:inbox:collapsed-groups";
