...
import { buildAgentMentionHref, buildProjectMentionHref, buildUserMentionHref } from "@softclipai/shared";
  ...
  if (richEditorError) {
    return (
      <div
        ref={containerRef}
        className={cn(
          "relative softclip-mdxeditor-scope",
  ...
  return (
    ...
    >
      <MDXEditor
        ...
        className={cn("softclip-mdxeditor", !bordered && "softclip-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "softclip-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
