 ...
 *
 * When the Softclip UI encounters an adapter type that doesn't have a
 ...
 * runtime dependencies, and Softclip's UI loads it on demand.
 */

import type { TranscriptEntry } from "@softclipai/adapter-utils";
