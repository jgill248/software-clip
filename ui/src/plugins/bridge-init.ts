 ...
 *
 * This is placed on `globalThis.__softclipPluginBridge__` and consumed by
...
declare global {
  ...
  var __softclipPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__softclipPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__softclipPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
