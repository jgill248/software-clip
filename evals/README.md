...
Eval framework for testing Softclip agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Softclip heartbeat skill:
