...
name: release
description: >
  Coordinate a full Softclip release across engineering verification, npm,
...
Run the full Softclip maintainer release workflow, not just an npm publish.
...
7. If running through Softclip, you have issue context for status updates and follow-up task creation.
...
Softclip now uses a commit-driven release model:
...
npm view softclip@canary version
```
...
- release summary in Softclip issue context
