...
description: >
  Generate the stable Softclip release changelog at releases/vYYYY.MDD.P.md by
  reading commits, changesets, and merged PR context since the last stable tag.
---

# Release Changelog Skill

Generate the user-facing changelog for the **stable** Softclip release.

## Versioning Model

Softclip uses **calendar versioning (calver)**:
...
```
- **Feature name** — Description. ([#123](https://github.com/jgill248/software-clip/pull/123), @contributor1, @contributor2)
```
