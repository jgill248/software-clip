...
import { models as codexFallbackModels } from "@softclipai/adapter-codex-local";
import { models as cursorFallbackModels } from "@softclipai/adapter-cursor-local";
import { models as opencodeFallbackModels } from "@softclipai/adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@softclipai/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.SOFTCLIP_OPENCODE_COMMAND;
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.SOFTCLIP_OPENCODE_COMMAND = "__softclip_missing_opencode_command__";
