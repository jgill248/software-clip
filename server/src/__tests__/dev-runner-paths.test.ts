...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local Softclip state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".softclip/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/softclip",
      ),
    ).toBe(false);
