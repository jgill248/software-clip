/**
 * Server-side SVG renderer for Softclip org charts.
...
// Softclip logo: scaled icon (~16px) + wordmark (13px), vertically centered
const SOFTCLIP_LOGO_SVG = `<g>
  ...
  <text x="22" y="11.5" font-family="system-ui, -apple-system, sans-serif" font-size="13" font-weight="600" fill="currentColor">Softclip</text>
</g>`;
