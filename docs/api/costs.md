...
```
POST /api/products/{companyId}/cost-events
{
  "agentId": "{agentId}",
  "provider": "anthropic",
...
```
GET /api/products/{companyId}/costs/summary
```
...
```
GET /api/products/{companyId}/costs/by-agent
```
...
```
GET /api/products/{companyId}/costs/by-project
```
