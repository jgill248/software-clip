...
- `SOFTCLIP_APPROVAL_ID` — the resolved approval
- `SOFTCLIP_APPROVAL_STATUS` — `approved` or `rejected`
- `SOFTCLIP_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
