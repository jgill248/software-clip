...
Softclip supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying Softclip?** Use `local_trusted` (the default)
