CREATE TABLE IF NOT EXISTS "feedback_exports" (
	...
	"schema_version" text DEFAULT 'softclip-feedback-envelope-v2' NOT NULL,
	"bundle_version" text DEFAULT 'softclip-feedback-bundle-v2' NOT NULL,
	"payload_version" text DEFAULT 'softclip-feedback-v1' NOT NULL,
	"payload_digest" text,
