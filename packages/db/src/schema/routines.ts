...
export const routines = pgTable(
  ...
  (table) => ({
    companyStatusIdx: index("routines_product_status_idx").on(table.companyId, table.status),
    companyAssigneeIdx: index("routines_product_assignee_idx").on(table.companyId, table.assigneeAgentId),
    companyProjectIdx: index("routines_product_project_idx").on(table.companyId, table.projectId),
  }),
);
...
export const routineTriggers = pgTable(
  ...
  (table) => ({
    companyRoutineIdx: index("routine_triggers_product_routine_idx").on(table.companyId, table.routineId),
    companyKindIdx: index("routine_triggers_product_kind_idx").on(table.companyId, table.kind),
...
export const routineRuns = pgTable(
  ...
  (table) => ({
    companyRoutineIdx: index("routine_runs_product_routine_idx").on(table.companyId, table.routineId, table.createdAt),
