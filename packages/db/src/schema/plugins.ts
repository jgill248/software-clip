...
import type { PluginCategory, PluginStatus, SoftclipPluginManifestV1 } from "@softclipai/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<SoftclipPluginManifestV1>().notNull(),
