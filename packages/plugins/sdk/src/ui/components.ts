 ...
 *
 * These components are exported from `@softclipai/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@softclipai/plugin-sdk/ui`
 */
...
function createSdkUiComponent<TProps>(name: string): React.ComponentType<TProps> {
  return function SoftclipSdkUiComponent(props: TProps) {
