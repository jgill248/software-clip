/**
 * `definePlugin` — the top-level helper for authoring a Softclip plugin.
 *
...
// ---------------------------------------------------------------------------
// SoftclipPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface SoftclipPlugin {
 ...
 * @returns A sealed `SoftclipPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@softclipai/plugin-sdk";
