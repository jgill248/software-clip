import type { PluginLauncherRegistration } from "@softclipai/plugin-sdk";

export const PLUGIN_ID = "softclip-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".softclip-kitchen-sink-demo.txt",
} as const;
