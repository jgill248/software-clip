...
This document describes how `@softclipai/adapter-openclaw-gateway` invokes OpenClaw over the Gateway protocol.
...
5. stream `event agent` frames into Softclip logs/transcript parsing
