...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within SoftclipPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Softclip host.
 *
...
export interface SoftclipPluginManifestV1 {
   ...
   */
  minimumSoftclipVersion?: PluginMinimumHostVersion;
